...
0000000000400ee0 <phase_1>: ;输入的字符串必须是 "Border relations with Canada have never been better."，否则爆炸
  ...
  400eee:	85 c0                	test   %eax,%eax ;如果相等，eax = 0，否则eax = 1
  400ef0:	74 05                	je     400ef7 <phase_1+0x17> ;如果相等，跳转到 400ef7
  400ef2:	e8 43 05 00 00       	callq  40143a <explode_bomb> ;如果不相等，爆炸
...
0000000000400fce <func4>: 
  ...
  400fdd:	d1 f8                	sar    %eax ;eax = (edx - esi) / 2
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx ;ecx = rax + rsi * 1
  400fe2:	39 f9                	cmp    %edi,%ecx ;edi == (ecx = (edx + esi) / 2)
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24> ;edi <= ecx ,跳转
  ...
  400ff9:	7d 0c                	jge    401007 <func4+0x39> ;edi >= ecx ,跳转出函数
...
000000000040100c <phase_4>: ;输入的字符串必须是 "0 0" or "1 0" or "3 0" or "7 0"，否则爆炸，该关卡为二分查找
  ...
  401029:	83 f8 02             	cmp    $0x2,%eax ;读取两个数字
  ...
  40104f:	75 07                	jne    401058 <phase_4+0x4c> ;不为0则爆炸
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp) ;判断第二个数字是否为0
  401056:	74 05                	je     40105d <phase_4+0x51> ;为0则跳转
  401058:	e8 dd 03 00 00       	callq  40143a <explode_bomb>
  40105d:	48 83 c4 18          	add    $0x18,%rsp
  401061:	c3                   	retq   

0000000000401062 <phase_5>: ;输入的字符串必须是 "ionefg"，否则爆炸，该关卡为查表
  401062:	53                   	push   %rbx
  401063:	48 83 ec 20          	sub    $0x20,%rsp
  401067:	48 89 fb             	mov    %rdi,%rbx ;rbx = input 的地址
  ...
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx ;读取字符串的每一个字符
  40108f:	88 0c 24             	mov    %cl,(%rsp) ;存入栈中
  401092:	48 8b 14 24          	mov    (%rsp),%rdx ;rdx = 栈顶
  401096:	83 e2 0f             	and    $0xf,%edx ;edx = rdx & 0xf
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx ;edx = 0x4024b0[rdx] 0x4024b0 = "maduiersnfotvbyl"
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1) ;存入栈中
  4010a4:	48 83 c0 01          	add    $0x1,%rax ;rax++
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax ;判断是否读取完毕
  4010ac:	75 dd                	jne    40108b <phase_5+0x29>
  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp) ;字符串结尾
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi ;esi = "flyers"
  4010b8:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi ;rdi = 栈顶
  4010bd:	e8 76 02 00 00       	callq  401338 <strings_not_equal>
  4010c2:	85 c0                	test   %eax,%eax ;判断返回值是否为0
  4010c4:	74 13                	je     4010d9 <phase_5+0x77> ;为0则跳转，否则爆炸
  4010c6:	e8 6f 03 00 00       	callq  40143a <explode_bomb>
  4010cb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
  4010d0:	eb 07                	jmp    4010d9 <phase_5+0x77>
  4010d2:	b8 00 00 00 00       	mov    $0x0,%eax ;eax = 0
  4010d7:	eb b2                	jmp    40108b <phase_5+0x29>
  4010d9:	48 8b 44 24 18       	mov    0x18(%rsp),%rax ;rax = fs:0x28
  4010de:	64 48 33 04 25 28 00 	xor    %fs:0x28,%rax ;rax = fs:0x28 ^ rax
  4010e5:	00 00 
  4010e7:	74 05                	je     4010ee <phase_5+0x8c> ;为0则跳转
  4010e9:	e8 42 fa ff ff       	callq  400b30 <__stack_chk_fail@plt> ;
  4010ee:	48 83 c4 20          	add    $0x20,%rsp
  4010f2:	5b                   	pop    %rbx
  4010f3:	c3                   	retq   

00000000004010f4 <phase_6>: ;输入的字符串必须为"4 3 2 1 6 5"，否则爆炸，该关卡为排序
  ...
  40110b:	49 89 e6             	mov    %rsp,%r14  ;r14 = 栈顶
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d 
  401114:	4c 89 ed             	mov    %r13,%rbp ;rbp = 栈顶
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax ;取出数字
  40111b:	83 e8 01             	sub    $0x1,%eax ;eax--
  40111e:	83 f8 05             	cmp    $0x5,%eax ;判断是否小于等于5
  401121:	76 05                	jbe    401128 <phase_6+0x34> ;小于等于5则跳转
  401123:	e8 12 03 00 00       	callq  40143a <explode_bomb>
  401128:	41 83 c4 01          	add    $0x1,%r12d ;r12d++
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d ;判断是否读取完毕
  ...
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp) ;判断eax是否等于*(rbp)
  40113e:	75 05                	jne    401145 <phase_6+0x51> ;不等则跳转
  401140:	e8 f5 02 00 00       	callq  40143a <explode_bomb>
  401145:	83 c3 01             	add    $0x1,%ebx ;ebx++
  401148:	83 fb 05             	cmp    $0x5,%ebx ;判断ebx是否小于5
  40114b:	7e e8                	jle    401135 <phase_6+0x41> ;小于5则跳转
  40114d:	49 83 c5 04          	add    $0x4,%r13 ;r13 += 4
  401151:	eb c1                	jmp    401114 <phase_6+0x20> ;跳转
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi ;rsi = 栈顶 + 0x18
  ...
  40116a:	48 39 f0             	cmp    %rsi,%rax ;判断rax是否等于rsi
  40116d:	75 f1                	jne    401160 <phase_6+0x6c> ;不等则跳转
  40116f:	be 00 00 00 00       	mov    $0x0,%esi ;esi = 0
  401174:	eb 21                	jmp    401197 <phase_6+0xa3>
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx ;rdx = rdx + 0x8
  40117a:	83 c0 01             	add    $0x1,%eax ;eax++
  40117d:	39 c8                	cmp    %ecx,%eax ;判断eax是否等于ecx
  40117f:	75 f5                	jne    401176 <phase_6+0x82> ;不等则跳转
  401181:	eb 05                	jmp    401188 <phase_6+0x94> ;跳转
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx ;edx = 76
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2) ;*(rsp + rsi * 2 + 0x20) = rdx
  40118d:	48 83 c6 04          	add    $0x4,%rsi ;rsi += 4
  401191:	48 83 fe 18          	cmp    $0x18,%rsi ;判断rsi是否等于0x18
  401195:	74 14                	je     4011ab <phase_6+0xb7> ;等于0x18则跳转
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx ;ecx = *(rsp + rsi)
  40119a:	83 f9 01             	cmp    $0x1,%ecx ;判断ecx是否小于等于1
  40119d:	7e e4                	jle    401183 <phase_6+0x8f> ;小于等于1则跳转
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax ;eax = 1
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx ;eax = 76
  ...
  4011c8:	48 39 f0             	cmp    %rsi,%rax ;判断rax是否等于rsi
  4011cb:	74 05                	je     4011d2 <phase_6+0xde> ;等于则跳转
  ...
  4011e7:	7d 05                	jge    4011ee <phase_6+0xfa> ; if eax >= *rbx,跳转，否则爆炸
  4011e9:	e8 4c 02 00 00       	callq  40143a <explode_bomb>
  4011ee:	48 8b 5b 08          	mov    0x8(%rbx),%rbx ; rbx = rbx + 8
  4011f2:	83 ed 01             	sub    $0x1,%ebp ; ebp = ebp - 1
  4011f5:	75 e8                	jne    4011df <phase_6+0xeb> ;如果ebp不为1，跳转
...
0000000000401338 <strings_not_equal>:
  ...
  40133a:	55                   	push   %rbp
  40133b:	53                   	push   %rbx
  40133c:	48 89 fb             	mov    %rdi,%rbx ;rbx = input 的地址
  40133f:	48 89 f5             	mov    %rsi,%rbp ;rbp = ans 的地址
  401342:	e8 d4 ff ff ff       	callq  40131b <string_length>
  401347:	41 89 c4             	mov    %eax,%r12d ;r12d = input 的长度
  40134a:	48 89 ef             	mov    %rbp,%rdi  ;rdi = ans 的地址
  40134d:	e8 c9 ff ff ff       	callq  40131b <string_length>
  401352:	ba 01 00 00 00       	mov    $0x1,%edx ;暂时标记为不相等
  401357:	41 39 c4             	cmp    %eax,%r12d ;比较input和ans的长度是否相等
  40135a:	75 3f                	jne    40139b <strings_not_equal+0x63> ;不相等就跳转到40139b，返回为1
  40135c:	0f b6 03             	movzbl (%rbx),%eax ;取出input的第一个字符
  40135f:	84 c0                	test   %al,%al ;判断是否为0
  401361:	74 25                	je     401388 <strings_not_equal+0x50> ;如果是0，就跳转到401388，返回为0
  401363:	3a 45 00             	cmp    0x0(%rbp),%al ;比较input的第一个字符和ans的第一个字符是否相等
  401366:	74 0a                	je     401372 <strings_not_equal+0x3a> ;如果相等，就跳转到401372，继续比较下一个字符
  401368:	eb 25                	jmp    40138f <strings_not_equal+0x57>
  40136a:	3a 45 00             	cmp    0x0(%rbp),%al ;比较input的下一个字符和ans的下一个字符是否相等
  40136d:	0f 1f 00             	nopl   (%rax) ;nop
  401370:	75 24                	jne    401396 <strings_not_equal+0x5e> ;如果不相等，就跳转到401396，返回为1
  401372:	48 83 c3 01          	add    $0x1,%rbx ;如果相等，就比较下一个字符
  401376:	48 83 c5 01          	add    $0x1,%rbp ;如果相等，就比较下一个字符
  40137a:	0f b6 03             	movzbl (%rbx),%eax ;取出input的下一个字符
  40137d:	84 c0                	test   %al,%al ;判断是否为0
  40137f:	75 e9                	jne    40136a <strings_not_equal+0x32> ;如果不为0，就跳转到40136a，继续比较下一个字符
  401381:	ba 00 00 00 00       	mov    $0x0,%edx ;如果input的第一个字符为0，就跳转到401386，返回为0
  401386:	eb 13                	jmp    40139b <strings_not_equal+0x63> 
  401388:	ba 00 00 00 00       	mov    $0x0,%edx ;如果input的第一个字符为0，就跳转到401386，返回为0
  40138d:	eb 0c                	jmp    40139b <strings_not_equal+0x63> 
  40138f:	ba 01 00 00 00       	mov    $0x1,%edx ;如果input的第一个字符不为0，就跳转到401396，返回为1
  401394:	eb 05                	jmp    40139b <strings_not_equal+0x63> 
  401396:	ba 01 00 00 00       	mov    $0x1,%edx ;如果input的第一个字符不为0，就跳转到401396，返回为1
